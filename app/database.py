...
class Database(object):
    ...
    def initialize():
        ...
        Database.DATABASE = client['mopase']
    ...
    def find(collection,data):
        return Database.DATABASE[collection].find(data).sort("Date", pymongo.DESCENDING)

    @staticmethod
    def find_report(collection,data):
    ...
    def delete(collection,id):
       return Database.DATABASE[collection].delete_one(id)